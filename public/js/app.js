...
!function(){app.controllers||(app.controllers={}),app.controllers.admin=function(n,o,t,i){n.init=function(){t(function(){i.isLoggedAlready()?o.transitionTo("me"):o.transitionTo("auth")})}},app.controller("AdminCtrl",["$scope","$state","$timeout","authService",app.controllers.admin])}();
